...
KNOWN_HERMES_MOUNTS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "rw": True,
        "label": "work-data Partition",
        "category": "Storage Root",
        "description": "Physische Partition für Arbeits- und Projektdaten",
    },
    {
        "host_path": "/media/privat-data/10_PrivatBüro",
        "container_path": "/opt/data/privat-buero",
        "rw": True,
        "label": "privat-data / 10_PrivatBüro",
        "category": "Storage Root",
        "description": "Verzeichnis auf der privaten Daten-Partition",
    },
    {
